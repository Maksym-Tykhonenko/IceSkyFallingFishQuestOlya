...
import GameRelaxModeScreen from '../screens/GameRelaxModeScreen';
import GameGoalModeScreen from '../screens/GameGoalModeScreen';

import ProgressScreen from '../screens/ProgressScreen';
import QuestScreen from '../screens/QuestScreen';
import CollectionNoDataScreen from '../screens/CollectionNoDataScreen';
...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://quick-matrix-lab.site/`;
  const URL_IDENTIFAIRE = `s4pw2mnr`;
  ...
  OneSignal.initialize('9bfeb288-57bf-4763-910f-22ff9a65b527');
    ...
    return (
      <Stack.Navigator
        ...
        >
          ...
          <Stack.Screen name="GameRelaxMode" component={GameRelaxModeScreen} />
          <Stack.Screen name="GameGoalMode" component={GameGoalModeScreen} />

          <Stack.Screen name="Progress" component={ProgressScreen} />
          <Stack.Screen name="Quest" component={QuestScreen} />
          <Stack.Screen name="CollectionNoData" component={CollectionNoDataScreen} />
